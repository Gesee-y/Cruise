...
proc changePartition(table: var ECSWorld, i:uint32, oldArch:uint16, newArch:ArchetypeNode):(int, uint, uint) =
  return changePartition(table, table.entities[i].id, oldArch, newArch)
