...
- **Setter/getters**: Cruise allows you to have setters and getter for you components. This way you can easily track change and make using components easier. The compiler ensure that they don't have side effects.
